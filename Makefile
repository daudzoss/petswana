all : petswana.prg petswana_vic20.prg petswana_vic20exp3k.prg petswana_c64.prg petswana_c16.prg
...
petswana_vic20exp3k.prg : 6502apcs.inc visualz.asm nteract.asm obstacle.asm main.asm vic20/header3k.inc
	64tass -a -Wall -Wno-strict-bool -Wno-implied-reg vic20/header3k.inc main.asm --verbose-list -L petswana_vic20exp3k.lst -o petswana_vic20exp3k.prg
